...
const Slide = ({ img, title, mainTitle, price }) => {
  return (
    <div className="outline-none border-none relative">
      <div className="absolute left-[30px] md:left-[30px] max-w-[250px] sm:max-w-[350px] top-[50%] transalte-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffa2] sm:bg-transpate p-4 sm:p-0 rounded-lg sm:rounded-none">
